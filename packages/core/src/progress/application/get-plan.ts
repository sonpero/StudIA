...
import type { Plan, ProgressInputError, PlanNotion } from "../domain/types.js";
...
// (docs/modules/progress.md). Never persists the computation.
export async function getPlan(deps: GetPlanDeps, userId: string, documentId: string, now: Date): Promise<Result<Plan, ProgressInputError>> {
