...
// A malformed request, not a workload that doesn't fit (docs/modules/progress.md).
export type ProgressInputError =
...
export type BuildPlanInput = {
  ...
  // array order directly as the best-effort fill priority (docs/modules/progress.md).
  notions: PlanNotion[];
