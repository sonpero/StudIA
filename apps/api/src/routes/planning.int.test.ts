...
// today is client-computed and required (docs/modules/planning.md): the
...
describe("planning routes", () => {
  ...
  beforeEach(async () => {
    dir = mkdtempSync(path.join(tmpdir(), "studia-api-planning-"));
  ...
  it("GET /api/documents/:id/plan is 422 (PlanningInputError) before availability is ever set", async () => {
