...
describe("ProgressScreen", () => {
  ...
  // way Notions' and Lecteur's own passes found this — CoursePill is
  // duplicated verbatim across all three files, each flagged in turn as a
  ...
  it("a course pill carries a 44px minimum height on mobile, reset back to its own natural height from md up", async () => {
    ...
    renderScreen();
    const pill = await screen.findByRole("button", { name: "Maths" });
