...
// server never guesses it, docs/modules/progress.md), so advancing the
...
test.describe("progress", () => {
  test("set a deadline two weeks out, see the daily plan, skip a day, see it redistribute", async ({ page }) => {
    ...
    // clock, formatted the way ProgressScreen renders it (fr-FR, lowercase
    ...
    // "skip" action exists (docs/modules/progress.md's Replanning section:
