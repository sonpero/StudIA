...
**Acceptance**
- [ ] The planner is a pure function, property-tested: never schedules past the deadline, never exceeds daily capacity, covers every notion
- [ ] Same inputs always yield the same plan (asserted)
